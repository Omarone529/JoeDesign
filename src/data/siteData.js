 ...
 */
/*
 * Ordine: anno più recente prima; a parità di anno, numerazione delle tavole
 * dell'archivio PDF sorgente (crescente). "grafica" non ha una tavola numerata
 * (raccoglie lavori 2024–2026): resta in coda al gruppo 2026.
 */
const progetti = [
  {
...
export const focusItems = focusSlugs.map((slug) => {
  ...
  // `cover-home.webp`: le copertine di archivio/scheda sono state sostituite con le
  // tavole dell'archivio PDF, ma in home restano le foto originali del prodotto.
  return { slug, title, cat, year, cover: `/images/products/${slug}/cover-home.webp` }
})
